...
BikerMethLab = {
    ...
    Style = {
        none = {"meth_lab_upgrade", "meth_lab_setup"}, empty = {"meth_lab_upgrade", "meth_lab_setup"}, basic = {"meth_lab_upgrade", "meth_lab_setup"}, upgrade = {"meth_lab_upgrade", "meth_lab_setup"},
    ...
    Security = {
        none = "meth_lab_security_high", upgrade = "meth_lab_security_high",
