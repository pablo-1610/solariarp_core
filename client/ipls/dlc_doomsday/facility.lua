...
DoomsdayFacility = {
            ...
            Enable = function(state)
                ...
                if (state) then
                    if (handle == 0) then
                        ...
                        local privacyGlass = CreateObject_(model, 367.99, 4827.745, -59.0, false, false, false)
                    ...
                    if (state) then
                        if (handle == 0) then
                            ...
                            if entityToAttach ~= 0 then
                                ...
                                local privacyGlass = CreateObject_(glass.modelHash, glass.entityPos.x, glass.entityPos.y, glass.entityPos.z, false, false, false)
    ...
    LoadDefault = function()
        ...
        DoomsdayFacility.Walls.SetColor(DoomsdayFacility.Colors.supermacy)
